...
document.getElementById("submit-btn").addEventListener("click", () => {
  const userInput = document.getElementById("user-answer").value.trim().replace(/\s+/g, "");
  const correct = randomQuestions.map(q => q.answer.trim()).join("");

  console.log("正確答案：", correct);
  console.log("使用者輸入：", userInput);
